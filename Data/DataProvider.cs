...
namespace Lifbi.Dnn.UserProfileLifbi.Dnn.UserProfile.Data
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Lifbi.Dnn.UserProfileLifbi.Dnn.UserProfile.Data.SqlDataprovider,Lifbi.Dnn.UserProfile";
